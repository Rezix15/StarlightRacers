...
public class TrackSegment : MonoBehaviour
{
   ...
   void GenerateMesh()
   {
      ...
      //List containing the vertices for our mesh
      List<Vector3> verts = new List<Vector3>();

      //List containing the normals for our mesh
      List<Vector3> normals = new List<Vector3>();
      
      //List containing the uvs for our mesh
      ...
      //List of triangles for our mesh
      ...
      for (int ring = 0; ring < edgeRingCount-1; ring++)
      {
         ...
         //Set vertices onto mesh
         mesh.SetVertices(verts);
         
         //Set normals to mesh
         mesh.SetNormals(normals);
         
         //Set triangles onto mesh
